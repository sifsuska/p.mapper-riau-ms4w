...
PM.scaleSelectList = ["50.000", "100.000", "250.000", "500.000", "1.000.000", "2.500.000", "5.000.000"];
...
/**
Update: agar pengukuran menggunakan meter, maka MAP sekarang saya proyeksikan
ke UTM Zona 47N, sehingga satuannya meter.

Untuk itu, di berkas config_default.xml, harus disetup agar di enable proj4js,
tambahkan baris berikut dalam <pmapper>
...
PM.ZoomBox.coordsDisplayDstPrj = "EPSG:4326";
PM.ZoomBox.coordsDisplayRfactor = 4; // 4 angka di belakang koma
